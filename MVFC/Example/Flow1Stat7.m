...
%-  Noise dist type: NON- Homogeneous Gaussian white noise with 0.01*Vmax standard deviation(STD)
%-  Outlier   Ratio: 10% cluster + 0 missing data
%
...
sigma= 0:0.01:0.1; % 0.01: standard deviation of Gaussian noise
outlierRatio = 0.10;
Ns = max(size(sigma));
...
%     parfor j=1:Ns
    for j=1:Ns
        ...
        [x,y,Vx,Vy,u,v,OutlierIndex_Truth] = simulateVelocity(32,sigma(j),outlierRatio);
...
%% Draw the results
% NRMSE
H1=figure();hold on;box on;xlim([0 0.1]);ylim([-0.01 0.21]);%title('\fontsize{12}NRMSE');
plot(sigma,MEAN_NRMSE_CON,'--d','LineWidth',2,'Color',[0.85,0.33,0.1], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.85,0.33,0.1]);
% plot(sigma,MEAN_NRMSE_CON1,'--h','LineWidth',2,'Color',[0.93,0.69,0.13], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.93,0.69,0.13]);
plot(sigma,MEAN_NRMSE_PPPIV,'-h','LineWidth',2,'Color',[0.93,0.69,0.13], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.93,0.69,0.13]);
plot(sigma,MEAN_NRMSE_VTM,'--p','LineWidth',2,'Color',[0.64,0.08,0.18], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.64,0.08,0.18]);
...
%SSIM
H2=figure();hold on;box on;xlim([0 0.1]);ylim([0.9 1.01]);%title('\fontsize{12}SSIM');
plot(sigma,MEAN_SSIM_CON,'--d','LineWidth',2,'Color',[0.85,0.33,0.1], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.85,0.33,0.1]);
% plot(sigma,MEAN_SSIM_CON1,'--h','LineWidth',2,'Color',[0.93,0.69,0.13], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.93,0.69,0.13]);
plot(sigma,MEAN_SSIM_PPPIV,'-h','LineWidth',2,'Color',[0.93,0.69,0.13], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.93,0.69,0.13]);
plot(sigma,MEAN_SSIM_VTM,'--p','LineWidth',2,'Color',[0.64,0.08,0.18], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.64,0.08,0.18]);
...
%UDC
H3=figure();hold on;box on;xlim([0 0.1]);set(gca,'yscale','log');%ylim([-0.01 1.01]);%title('\fontsize{12}NRMSE');
plot(sigma,MEAN_UDC_CON+1,'--d','LineWidth',2,'Color',[0.85,0.33,0.1], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.85,0.33,0.1]);
plot(sigma,MEAN_UDC_VTM+1,'--p','LineWidth',2,'Color',[0.64,0.08,0.18], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.64,0.08,0.18]);
plot(sigma,MEAN_UDC_FADV+1,'--+','LineWidth',2,'Color',[0.3,0.75,0.93], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.3,0.75,0.93]);
plot(sigma,MEAN_UDC_VFC+1,'--s','LineWidth',2,'Color',[0.47,0.67,0.19] , 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.47,0.67,0.19]);
plot(sigma,MEAN_UDC_MVFC+1,'-o','LineWidth',2,'Color',[0.49,0.18,0.56], 'MarkerSize',8, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.49,0.18,0.56]);
...
%ODC
H4=figure();hold on;box on;xlim([0 0.1]);set(gca,'yscale','log');%ylim([-0.01 1.01]);%title('\fontsize{12}SSIM');
plot(sigma,MEAN_ODC_CON+1,'--d','LineWidth',2,'Color',[0.85,0.33,0.1], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.85,0.33,0.1]);
plot(sigma,MEAN_ODC_VTM+1,'--p','LineWidth',2,'Color',[0.64,0.08,0.18], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.64,0.08,0.18]);
plot(sigma,MEAN_ODC_FADV+1,'--+','LineWidth',2,'Color',[0.3,0.75,0.93], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.3,0.75,0.93]);
plot(sigma,MEAN_ODC_VFC+1,'--s','LineWidth',2,'Color',[0.47,0.67,0.19] , 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.47,0.67,0.19]);
plot(sigma,MEAN_ODC_MVFC+1,'-o','LineWidth',2,'Color',[0.49,0.18,0.56], 'MarkerSize',8, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.49,0.18,0.56]);
...
%TWDC
H5=figure();hold on;box on;xlim([0 0.1]);set(gca,'yscale','log');%ylim([-0.01 1.01]);%title('\fontsize{12}SSIM');
plot(sigma,MEAN_ODC_CON+MEAN_UDC_CON+1,'--d','LineWidth',2,'Color',[0.85,0.33,0.1], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.85,0.33,0.1]);
plot(sigma,MEAN_ODC_VTM+MEAN_UDC_VTM+1,'--p','LineWidth',2,'Color',[0.64,0.08,0.18], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.64,0.08,0.18]);
plot(sigma,MEAN_ODC_FADV+MEAN_UDC_FADV+1,'--+','LineWidth',2,'Color',[0.3,0.75,0.93], 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.3,0.75,0.93]);
plot(sigma,MEAN_ODC_VFC+MEAN_UDC_VFC+1,'--s','LineWidth',2,'Color',[0.47,0.67,0.19] , 'MarkerSize',6, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.47,0.67,0.19]);
plot(sigma,MEAN_ODC_MVFC+MEAN_UDC_MVFC+1,'-o','LineWidth',2,'Color',[0.49,0.18,0.56], 'MarkerSize',8, 'MarkerEdgeColor','k', 'MarkerFaceColor',[0.49,0.18,0.56]);
H22=legend('\fontsize{14}NMT','\fontsize{14}VTM','\fontsize{14}FADV','\fontsize{14}VFC','\fontsize{14}MVFC',0);
xlabel('\fontsize{14}Maximal noise standard deviation:/V_{max} ');
...
Vx = Vx + U_max*(sigma)*randn(size(Vx)).*x; % adding Gaussian noise
Vy = Vy + U_max*(sigma)*randn(size(Vx)).*x; % adding Gaussian noise
